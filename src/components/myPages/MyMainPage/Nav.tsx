...
import mypage from "../../../assets/images/nav/마이페이지아이콘_클릭.png";
...
const Nav = () => {
  ...
  return (
    <Wrapper $isSmall={small}>
      ...
      <Button onClick={() => handleChattingButton()}>
        <Img src={chatting} alt="" />
        채팅
      </Button>
      <Button onClick={() => handleShoppingButton()}>
        <Img src={shopping} alt="" />
        쇼핑
      </Button>
      <Button style={{ color: "#5849D0" }} onClick={() => handleMyButton()}>
        <Img src={mypage} alt="" />
        마이페이지
      </Button>
    </Wrapper>
